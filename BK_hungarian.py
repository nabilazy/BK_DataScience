...
model_info = pickle.load(open('model_info_deployment.pkl', 'rb'))
...
with tab2:
  ...
  if file_uploaded:
    ...
    uploaded_df_normal = scaler.transform(uploaded_df)
    prediction_arr = model.predict(uploaded_df_normal)
